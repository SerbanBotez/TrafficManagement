...
def decode_video(conn, data, addr, model, model_names, ct, influx_client, client_type):
    while True:
        ...
        frame = detection.detect(model, frame, model_names, ct, influx_client, client_type)
